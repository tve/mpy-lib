...
STATIC mp_obj_t espidf_pcnt_filter_enable(mp_obj_t arg0) {
	// convert arg0
	uint val0 = (uint)mp_obj_get_int(arg0);
	// call
	const uint ret = pcnt_filter_enable(val0);
	return mp_obj_new_int(ret);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(espidf_pcnt_filter_enable_obj, espidf_pcnt_filter_enable);

STATIC mp_obj_t espidf_pcnt_filter_disable(mp_obj_t arg0) {
	// convert arg0
	uint val0 = (uint)mp_obj_get_int(arg0);
	// call
	const uint ret = pcnt_filter_disable(val0);
	return mp_obj_new_int(ret);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(espidf_pcnt_filter_disable_obj, espidf_pcnt_filter_disable);

STATIC mp_obj_t espidf_pcnt_set_filter_value(mp_obj_t arg0, mp_obj_t arg1) {
	// convert arg0
	uint val0 = (uint)mp_obj_get_int(arg0);
	// convert arg1
	uint val1 = (uint)mp_obj_get_int(arg1);
	// call
	const uint ret = pcnt_set_filter_value(val0, val1);
	return mp_obj_new_int(ret);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_2(espidf_pcnt_set_filter_value_obj, espidf_pcnt_set_filter_value);

STATIC mp_obj_t espidf_pcnt_get_filter_value(mp_obj_t arg0, mp_obj_t arg1) {
	// convert arg0
	uint val0 = (uint)mp_obj_get_int(arg0);
	// convert arg1
	void *val1 = 0;
	...
	// call
	const uint ret = pcnt_get_filter_value(val0, val1);
	return mp_obj_new_int(ret);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_2(espidf_pcnt_get_filter_value_obj, espidf_pcnt_get_filter_value);
...
mp_obj_t mpy_init(mp_obj_fun_bc_t *self, size_t n_args, size_t n_kw, mp_obj_t *args) {
	...
	mp_store_global(MP_QSTR_pcnt_filter_enable, MP_OBJ_FROM_PTR(&espidf_pcnt_filter_enable_obj));
	mp_store_global(MP_QSTR_pcnt_filter_disable, MP_OBJ_FROM_PTR(&espidf_pcnt_filter_disable_obj));
	mp_store_global(MP_QSTR_pcnt_set_filter_value, MP_OBJ_FROM_PTR(&espidf_pcnt_set_filter_value_obj));
	mp_store_global(MP_QSTR_pcnt_get_filter_value, MP_OBJ_FROM_PTR(&espidf_pcnt_get_filter_value_obj));
	mp_store_global(MP_QSTR_pcnt_config_t, mp_obj_new_int(sizeof(pcnt_config_t)));
